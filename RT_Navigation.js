...
var infinityrt_navigation = function (scene,w,h) {
   ...
   this._zoomFactor = 0.0;
	...
	this._linearFovAnim = true; //Use it only on scenes with negative dolly values. Otherwise, set it to false
   ...
   // Mode 2 Nav (Variables)
	...
	this._panMax = [16,100];    //[left, bottom];
	this._panMin = [-16,-100];  //[right, top];
